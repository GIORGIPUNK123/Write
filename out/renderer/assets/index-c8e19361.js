...
const Header = (props) => {
  ...
  if (props.loggedIn) {
    return /* @__PURE__ */ jsxs("header", { children: [
      /* @__PURE__ */ jsxs("div", { className: "flex justify-between items-center h-16 px-16", children: [
        /* @__PURE__ */ jsxs("div", { className: "flex text-center items-center", children: [
          props.goBack ? /* @__PURE__ */ jsx(
            "img",
            {
              src: goBackIcon,
          ...
          /* @__PURE__ */ jsx("h1", { className: "dark:text-white font-sans font-medium text-2xl", children: "Write" })
        ] }),
        /* @__PURE__ */ jsx("div", {}),
      ...
      /* @__PURE__ */ jsx(
        "div",
        {
          className: ` ${isClicked ? "" : "hidden"}  z-50 dark:text-white font-sans font-medium text-xl text-center absolute top-16 right-0 w-[30vw] h-[100vh] bg-primaryDark-600`,
          children: /* @__PURE__ */ jsxs("ul", { className: "flex flex-col mt-4 font-medium", children: [
            /* @__PURE__ */ jsx("li", { className: "py-2 pr-4 pl-3 border-b border-gray-100 hover:bg-primaryDark-800 rounded-md cursor-pointer flex justify-center", children: /* @__PURE__ */ jsxs("div", { className: "flex text-center items-center", children: [
              name,
              /* @__PURE__ */ jsx(
                "img",
                {
    ...
    return /* @__PURE__ */ jsxs("header", { className: "dark:bg-primaryDark flex justify-between items-center h-16 px-16", children: [
      /* @__PURE__ */ jsx("h1", { className: "dark:text-white font-sans font-medium text-2xl", children: "Write" }),
      /* @__PURE__ */ jsx("div", {}),
      /* @__PURE__ */ jsx(
        "button",
...
const MyBlock = (props) => {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "w-96  h-44 rounded-md dark:bg-primaryDark-700 dark:text-white flex flex-col items-center justify-evenly mx-6 my-6", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex", children: [
      /* @__PURE__ */ jsx("span", { className: "text-xl mr-1 font-semibold", children: props.name }),
      /* @__PURE__ */ jsx("img", { className: "w-8 ml-1", src: props.image, alt: "swordsIcon" })
    ] }),
    /* @__PURE__ */ jsx(Link, { to: props.link, children: /* @__PURE__ */ jsx("button", { className: "rounded-md w-44 h-12 bg-orange hover:bg-orange-400 transition-colors font-medium", children: "Play" }) })
  ] }) });
};
const Home = () => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Header, { loggedIn: true, goBack: false }),
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap justify-evenly h-full", children: [
      /* @__PURE__ */ jsx(MyBlock, { name: "solo", image: typewritericon, link: "./solo" }),
      /* @__PURE__ */ jsx(MyBlock, { name: "duel", image: duelIcon, link: "./solo" }),
      /* @__PURE__ */ jsx(MyBlock, { name: "ranked", image: swordsIcon, link: "./solo" })
    ] })
  ] });
};
const WPMCounter = (props) => {
  return /* @__PURE__ */ jsx("div", { className: "flex items-center", children: /* @__PURE__ */ jsxs("div", { className: "w-min min-w-min max-w-2xl h-8 dark:bg-primaryDark-800 border-solid border-x-orange border-t-orange border-b-primaryDark-600 border-2 rounded-sm dark:text-white px-3", children: [
    /* @__PURE__ */ jsx("span", { children: "WPM:" }),
    /* @__PURE__ */ jsx("span", { className: "ml-1", children: props.wpm })
  ] }) });
};
const FinishScreen = (props) => {
  return /* @__PURE__ */ jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxs("h1", { className: "text-center text-white font-medium text-2xl border-solid border-4 border-orange py-2 px-2 rounded-md", children: [
          "Hi your wpm was ",
          props.wpm !== 0 ? props.wpm : "Loading"
        ] }),
...
const calculateWPM = (wordsCount, seconds) => seconds === 0 ? 0 : Math.round(wordsCount * 60 / seconds * 100) / 100;
const TextDisplayBox = (props) => {
  const MyComponent = (props2) => {
    if (props2.correct) {
      return /* @__PURE__ */ jsx(
        "div",
        {
          className: ` ${props2.wordsCount === props2.index ? "text-orange" : ""} flex w-min mr-1 ${props2.wordsCount > props2.index ? "opacity-75" : ""}`,
          children: props2.spanLetters
        },
        props2.index
      );
    } else
      return /* @__PURE__ */ jsx(
        "div",
        {
          className: ` ${props2.wordsCount === props2.index ? "text-red-600" : ""} flex w-min mr-1 ${props2.wordsCount > props2.index ? "opacity-75" : ""}`,
          children: props2.spanLetters
        },
        props2.index
      );
  };
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "w-[80%] text-center dark:text-primaryDark-100 font-sans font-medium text-2xl border-primaryDark-200 min-h-[100px] border-4 border-solid rounded-md py-4 items-center relative", children: /* @__PURE__ */ jsx("div", { className: "flex justify-center flex-wrap mx-4", children: props.wordsArr.map((word, dadIndex) => {
    const letters = word.split("");
    const spanLetters = letters.map((letter, index2) => {
      return /* @__PURE__ */ jsx("span", { children: letter }, index2);
    });
    return /* @__PURE__ */ jsx(
      MyComponent,
      {
...
const isCorrectWord = (inputWord, correctWord, callbackCompletedWordsCount, callbackInputText) => {
...
const TypeInput = (props) => {
  ...
  return /* @__PURE__ */ jsx(
    "input",
    {
      ...
      autoFocus: true,
      className: `bg-transparent caret-orange outline-orange ${correct ? "border-orange" : "border-red-500 outline-none"} border-orange  mt-16 w-[80%] text-center dark:text-primaryDark-100 font-sans font-medium text-2xl  h-16 border-4 border-solid rounded-md py-4 items-center`
    }
  );
};
const fetchWords = async (amount, callbackFunc) => {
  try {
...
const Solo = () => {
  const [wordsArr, setWordsArr] = reactExports.useState([]);
  const [completedWordsCount, setCompletedWordsCount] = reactExports.useState(0);
  const [startTime, setStartTime] = reactExports.useState(0);
  const [difference, setDifference] = reactExports.useState(0);
  const [isCorrectWord2, setIsCorrectWord] = reactExports.useState(false);
  const staticDifference = reactExports.useRef(0);
  const resetGame = () => {
    setWordsArr([]);
    ...
    setStartTime(Math.round(Date.now() / 1e3));
  };
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    const interval = setInterval(() => {
      setDifference(Math.round(Date.now() / 1e3) - startTime);
    }, 1e3);
  ...
  const renderTextDisplay = () => {
    return /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center mt-24", children: [
      /* @__PURE__ */ jsx(
        TextDisplayBox,
        {
          wordsArr,
          wordsCount: completedWordsCount,
          isCorrectWord: isCorrectWord2
        }
      ),
      /* @__PURE__ */ jsx(
        TypeInput,
  ...
  const renderFinishScreen = () => {
    if (wordsArr.length !== 0 && completedWordsCount === wordsArr.length) {
      return /* @__PURE__ */ jsx(
        FinishScreen,
        {
          className: `${completedWordsCount !== wordsArr.length ? "hidden" : ""}`,
  ...
  const renderLittleCounter = () => /* @__PURE__ */ jsx("div", { className: "flex justify-center", children: /* @__PURE__ */ jsx("div", { className: "absolute right-[10%] bottom-0", children: /* @__PURE__ */ jsx(
    WPMCounter,
    {
      wpm: completedWordsCount === wordsArr.length ? calculateWPM(completedWordsCount, staticDifference.current) : calculateWPM(completedWordsCount, difference)
    }
  ) }) });
  const onCompletedWordsCountChange = (count) => {
    setCompletedWordsCount(count);
  };
  const isCorrectWordChange = (correctness) => {
    setIsCorrectWord(correctness);
  };
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Header, { loggedIn: true, goBack: true }),
    renderFinishScreen(),
    renderTextDisplay(),
    renderLittleCounter()
  ] });
};
const NoMatch = () => /* @__PURE__ */ jsx("h1", { className: "text-white text-2xl font-medium", children: "Hi idiots" });
const App = () => {
  return /* @__PURE__ */ jsx(HashRouter, { children: /* @__PURE__ */ jsxs(Routes, { children: [
    /* @__PURE__ */ jsx(Route, { path: "/", element: /* @__PURE__ */ jsx(Home, {}) }),
    /* @__PURE__ */ jsx(Route, { path: "/solo", element: /* @__PURE__ */ jsx(Solo, {}) }),
